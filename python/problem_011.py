...
""" Solution to "Largest product in a grid", aka Problem 11
...
def find_largest_product_adjacent(grid, n):
    return max( find_largest_product_horizontal(grid, n), 
                find_largest_product_vertical(grid, n), 
                find_largest_product_diagonal(grid, n))
